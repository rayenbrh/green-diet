        ...
        <div className="mx-auto flex h-full max-w-[1320px] items-center justify-between px-4 md:px-8 lg:px-12">
          ...
          <div className="flex items-center gap-1 md:gap-3">
            <button
              ...
              className="relative flex h-11 w-11 cursor-pointer items-center justify-center rounded-full text-leaf transition hover:bg-cream focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-leaf/50 md:h-10 md:w-10 md:text-text-main"
              onClick={openDrawer}
            >
              <BagIcon />
              ...
              <div className="hidden items-center gap-2 md:flex">
                {isAuthenticated ? (
                  <NavLink
                    to="/compte"
                    className={({ isActive }) =>
                      `rounded-pill px-3 py-2 font-dm text-[13px] font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-leaf/50 ${
                        isActive ? 'bg-[rgba(74,124,89,0.12)] text-leaf' : 'text-text-muted hover:text-leaf'
                      }`
                    }
                  >
                    Mon compte
                  ...
                  <>
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        `rounded-pill px-3 py-2 font-dm text-[13px] font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-leaf/50 ${
                          isActive ? 'text-leaf' : 'text-text-muted hover:text-leaf'
                        }`
                      }
                    >
                      Connexion
                    ...
                    <NavLink
                      to="/inscription"
                      className="rounded-pill border border-leaf px-3 py-2 font-dm text-[13px] font-medium text-leaf transition hover:bg-[rgba(74,124,89,0.06)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-leaf/50"
                    >
                      S’inscrire
                    </NavLink>
                  </>
            ...
            >
              <span
                className={`block h-0.5 w-[18px] origin-center rounded-sm bg-leaf transition duration-200 ease-out ${
                  mobileOpen ? 'translate-y-[7px] rotate-45' : ''
                }`}
              />
              <span
                className={`block h-0.5 w-[18px] rounded-sm bg-leaf transition duration-200 ease-out ${
                  mobileOpen ? 'origin-center scale-x-0 opacity-0' : ''
                }`}
              />
              <span
                className={`block h-0.5 w-[18px] origin-center rounded-sm bg-leaf transition duration-200 ease-out ${
